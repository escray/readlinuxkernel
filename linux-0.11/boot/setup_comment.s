...
!
 ...
 !/////////////////////////////////////////////////////////
 !/////////////////////////////////////////////////////////
 ! 使用如下的.word 0x00eb,0x00eb 来起到延迟的作用。下面是相
...
! absolute address 0x00000, in 32-bit protected mode.
 ...
 !////////////////////////////////////////////////
 ! 加载cr0
 ！CR0寄存器：0号32位控制寄存器，存放系统控制标志。
 ！第0位为PE（Protected Mode Enable，保护！模式使能）标志，
 ...
 ！1000的最后两位（00）表示内核特权级，与之相对的用户特权级是11；
 ！第三位的0表示GDT，如果是1，则表示LDT；1000的1表示所选的表(GDT)的 1 项
